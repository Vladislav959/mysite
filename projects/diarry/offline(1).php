...
<div class="modal animated fadeIn" id="modal">
    <p>Unable to connect to Internet. Please try again soon.</p><a href="javascript:location.reload(true)">
<button class="refresh mdl-button mdl-js-button mdl-button--raised mdl-button--colored mdl-js-ripple-effect">Refresh</button></a>
</div>
<script>
